...
This folder contains Python code & Jupyter notebooks that encapsulate the processing needed to reproduce the results of the paper **PLUME-OCT: A quality control tool to enhance statistical power in the analysis of biomarkers from 3D biomedical datasets of OCT images** freely available at https://www.sciencedirect.com/science/article/pii/S0010482525017743
 The project, led by M. Tomasoni, started on 02.2022 with G. Molas, A. Bouillon on 09.2022, L Gürtler on 02.2023, has been taken on by A. Milloz and finalized by Y. Paychere. The overall aim is to develop a pre-processing tools to assign a score to OCT cube in order to define them as useable or not for further analysis.
